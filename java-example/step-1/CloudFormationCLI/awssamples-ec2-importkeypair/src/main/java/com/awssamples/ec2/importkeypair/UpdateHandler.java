    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(request.getDesiredResourceState(), callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWSSamples-EC2-ImportKeyPair::Update::PreUpdateCheck", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                ...
                proxy.initiate("AWSSamples-EC2-ImportKeyPair::Update::first", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
            ...
            .then(progress ->
                    ...
                    proxy.initiate("AWSSamples-EC2-ImportKeyPair::Update::second", proxyClient, progress.getResourceModel(), progress.getCallbackContext())
